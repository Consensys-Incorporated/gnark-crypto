...
func randElementExt(rng *rand.Rand) fext.E3 {
	var v fext.E3
	v.A0 = mamabear.Element{rng.Uint64N(562932773552129)}
	v.A1 = mamabear.Element{rng.Uint64N(562932773552129)}
	v.A2 = mamabear.Element{rng.Uint64N(562932773552129)}
	return v
}
...
func FuzzFFTExt(f *testing.F) {
	f.Fuzz(func(t *testing.T, domainSize uint16, rngSeed int64) {
		...
		a, b := make([]fext.E3, cardinality), make([]fext.E3, cardinality)
