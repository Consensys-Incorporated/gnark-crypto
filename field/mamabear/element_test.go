...
func TestElementFixedExp(t *testing.T) {
	...
	const sqrtExponentElement = "3fff"
	...
	_bCbrtExponentElement, _ = new(big.Int).SetString("15552aaaaaaab", 16)

	properties.Property("ExpByCbrt2q1o3 must match Exp(15552aaaaaaab)", prop.ForAll(
		func(a testPairElement) bool {
			c := a.element
			d := a.element
			c.ExpByCbrt2q1o3(c)
