...
func TestFoldBilinear(t *testing.T) {
	...
	for range 100 {
		...
		// f = c₀ + c₁ X₁ + c₂ X₂ + c₃ X₁ X₂
		var coefficients [4]extensions.E6
		extensions.VectorE6(coefficients[:]).MustSetRandom()
		...
		var expected0, expected1 extensions.E6
		expected0.
...
func TestFoldedEqTable(t *testing.T) {
	...
	eq := make([]extensions.E6, 4)
	p := make([]extensions.E6, 2)

	var one extensions.E6
	one.SetOne()
