...
func TestG2Endomorphism(t *testing.T) {
	...
	properties.Property("[BLS24-317] [3]P == [2]P+P", prop.ForAll(
		func(a fptower.E4) bool {
			var p, res1, res2 G2Jac
			g := MapToG2(a)
			p.FromAffine(&g)
...
func TestIsInSubGroupBatchG2(t *testing.T) {
	...
	properties.Property("[BLS24-317] IsInSubGroupBatchG2 test should pass with high probability", prop.ForAll(
...
func TestG2AffineOps(t *testing.T) {
	...
	properties.Property("[BLS24-317] Doubling a point of order 2 should return the point at infinity", prop.ForAll(
		func(a fptower.E4) bool {
