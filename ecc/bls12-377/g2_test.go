...
func TestG2Endomorphism(t *testing.T) {
	...
	properties.Property("[BLS12-377] [3]P == [2]P+P", prop.ForAll(
		func(a fptower.E2) bool {
			var p, res1, res2 G2Jac
			g := MapToG2(a)
			p.FromAffine(&g)
...
func TestG2AffineOps(t *testing.T) {
	...
	properties.Property("[BLS12-377] Doubling a point of order 2 should return the point at infinity", prop.ForAll(
		func(a fptower.E2) bool {
