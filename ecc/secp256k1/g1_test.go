...
func TestG1Endomorphism(t *testing.T) {
	...
	properties.Property("[SECP256K1] [3]P == [2]P+P", prop.ForAll(
		func(a fp.Element) bool {
			var p, res1, res2 G1Jac
			g := MapToG1(a)
			p.FromAffine(&g)
...
func TestIsInSubGroupBatchG1(t *testing.T) {
	...
	properties.Property("[SECP256K1] IsInSubGroupBatchG1 test should pass with high probability", prop.ForAll(
...
func TestG1AffineOps(t *testing.T) {
	...
	properties.Property("[SECP256K1] Doubling a point of order 2 should return the point at infinity", prop.ForAll(
		func(a fp.Element) bool {
