...
func TestIsInSubGroupBatchG1(t *testing.T) {
	...
	properties.Property("[SECP256R1] IsInSubGroupBatchG1 test should pass with high probability", prop.ForAll(
...
func TestG1AffineOps(t *testing.T) {
	...
	properties.Property("[SECP256R1] Doubling a point of order 2 should return the point at infinity", prop.ForAll(
		func(a fp.Element) bool {
...
func TestG1BatchScalarMultiplication(t *testing.T) {
	...
	properties.Property("[SECP256R1] BatchScalarMultiplication should be consistent with individual scalar multiplications", prop.ForAll(
		func(mixer fr.Element) bool {
