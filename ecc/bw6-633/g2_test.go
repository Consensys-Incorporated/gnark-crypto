...
func TestIsInSubGroupBatchG2(t *testing.T) {
	...
	properties.Property("[BW6-633] IsInSubGroupBatchG2 test should pass with high probability", prop.ForAll(
...
func TestG2AffineOps(t *testing.T) {
	...
	properties.Property("[BW6-633] Doubling a point of order 2 should return the point at infinity", prop.ForAll(
		func(a fp.Element) bool {
